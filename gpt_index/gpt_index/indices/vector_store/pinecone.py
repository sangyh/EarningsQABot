...
class GPTPineconeIndex(BaseGPTIndex[PineconeIndexStruct]):
    ...
    def __init__(
        ...
        addtnl_metadata: Optional[list] = None, #added by sangy
        **kwargs: Any,
    ) -> None:
        """Initialize params."""
        import_err_msg = (
        ...
        self.addtnl_metadata = addtnl_metadata or [] #added by sangy
    ...
    def _add_document_to_index(
        ...
        addtnl_metadata: Dict                   #added by sangy
    ) -> None:
        ...
        for n in nodes:
            ...
            metadata = metadata | addtnl_metadata #edited by sangy
    ...
    def _build_index_from_documents(
        ...
        for d in documents:
            ind = documents.index(d)
            add_metadata = self.addtnl_metadata[ind] #dict #added by sangy
            self._add_document_to_index(index_struct, d, text_splitter, add_metadata) #edited by sangy
        return index_struct
