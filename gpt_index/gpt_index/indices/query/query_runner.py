...
class QueryRunner(BaseQueryRunner):
    ...
    def __init__(
        ...
        query_metadata: Optional[Dict] = None,  #added by sangy
        ...
        self.query_metadata = query_metadata #added by sangy
        #print('Query metadata to filter (from qyery runner.py):',self.query_metadata)  #added by sangy
    ...
    def _get_query_kwargs(self, config: QueryConfig) -> Dict[str, Any]:
        ...
        if "query_metadata" not in query_kwargs: #added by sangy
            query_kwargs["query_metadata"] = self.query_metadata #added by sangy
    ...
    def query(
        ...
        #print('Query kwargs (from qyery runner.py):',query_kwargs)  #added by sangy
